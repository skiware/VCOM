  ...
  function(input,output,session){
    ...
    observeEvent(input$buttonRun,{
      ...
      INTERVENTION_PARAMETERS <<- getInterventionsParameters(
        OVIcov=input$OVIcov,0,LARcov=input$LARcov,BIOcov=input$BIOcov,SREcov=input$SREcov,ITNcov=input$ITNcov,
        ...
        time_OVI_on=input$time_OVI_on,0,time_LAR_on=input$time_LAR_on,time_BIO_on=input$time_BIO_on,
