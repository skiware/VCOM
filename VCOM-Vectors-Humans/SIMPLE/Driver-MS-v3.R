...
#INTERVENTION_PARAMETERS = getInterventionsParameters
  ...
  if (i==2){
    ...
    IVM_traj_ITN_LAR_5070 <<- runODE(INITIAL_MODELRUNTIME_VALUE,1,initState,theta,"lsoda")
  }

  if (i==3){
    
    IVM_traj_ITN_LAR_ATSB_507050 <<- runODE(INITIAL_MODELRUNTIME_VALUE,1,initState,theta,"lsoda")
  }
  if (i==4){

    
    IVM_traj_ITN_LAR_ATSB_ECS_50705050 <<- runODE(INITIAL_MODELRUNTIME_VALUE,1,initState,theta,"lsoda")
  }
...
barChart_MS_Other   (IVM_traj_Control,IVM_traj_ITN_LAR_5070,IVM_traj_ITN_LAR_ATSB_507050,IVM_traj_ITN_LAR_ATSB_ECS_50705050 )
